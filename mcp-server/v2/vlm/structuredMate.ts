...
function buildMatePrompt(params: { images: VlmImage[]; parts: VlmPart[]; mateContext: unknown; mode: 'initial' | 'repair'; previousRaw?: string; validationError?: unknown }) {
  ...
  const promptLines = [
    ...
    'Prefer semantic correctness (cover/insert/flush) and geometric feasibility over center-offset illusions.',
    ...
    'Face directions should follow captureFrame axes (target-part frame), not global world axes.',
